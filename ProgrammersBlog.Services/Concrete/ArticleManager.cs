...
namespace ProgrammersBlog.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IResult> Add(ArticleAddDto articleAddDto, string createdByName)
        {
            ...
            // session yapısı olmadığı için userı elle giriyoruz
            article.UserId = 1;
            await _unitOfWork.Articles.AddAsync(article).ContinueWith(t=> _unitOfWork.SaveAsync());
            return new Resulst(ResultStatus.Success, $"{articleAddDto.Title} başlıklı makale başarıyla eklenmiştir.");
        }
        public async Task<IResult> Update(ArticleUpdateDto articleUpdateDto, string modifiedByName)
        {
            ...
            return new Resulst(ResultStatus.Success, $"{articleUpdateDto.Title} başlıklı makale başarıyla güncellenmiştir.");
        ...
        public async Task<IResult> Delete(int articleId, string modifiedByName)
        {
            ...
            if (result)
            {
                ...
                return new Resulst(ResultStatus.Success, $"{article.Title} başlıklı makale başarıyla Silinmiştir.");

            }
            return new Resulst(ResultStatus.Error, "Böyle bir makale bulunamadı.");
        }
